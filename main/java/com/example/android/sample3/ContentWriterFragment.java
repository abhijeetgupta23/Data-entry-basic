...
public class ContentWriterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_content_writer, container, false);
        // Find the root view so we can add child views to it
        ScrollView rootView = (ScrollView) v.findViewById(R.id.content);
        ...
        Log.e("Text in Content",buffer.toString());
