...
public class GraphicDesignersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_graphic_designers, container, false);
        // Find the root view so we can add child views to it
        ScrollView rootView = (ScrollView) v.findViewById(R.id.graphics);
        ...
        Log.e("Text in Graphics",buffer.toString());
