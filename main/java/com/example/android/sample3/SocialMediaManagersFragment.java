...
public class SocialMediaManagersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_social_media_managers, container, false);
        // Find the root view so we can add child views to it
        ScrollView rootView = (ScrollView) v.findViewById(R.id.social);
        ...
        Log.e("Text in Social",buffer.toString());
