...
public class BusinessDevelopmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_business_development, container, false);
        // Find the root view so we can add child views to it
        ScrollView rootView = (ScrollView) v.findViewById(R.id.bd);
        ...
        Log.e("Dept in Business Dev", dept);
        ...
        Log.e("Text in Business Dev",buffer.toString());
